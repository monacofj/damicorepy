...
try:
  ...
  def to_graph(tree, g=None, serial=None, is_unrooted=True):
    ...
    c = tree.content if tree.content is not None else str(next(serial))#(serial.next()) from Python 2 to 3 iter.next() to next(iter)
...
if __name__ == '__main__':
  ...
  #label order in expected_ids and ids are different
